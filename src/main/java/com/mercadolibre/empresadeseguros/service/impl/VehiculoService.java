...
public class VehiculoService implements IVehiculoService {
    ...
    @Override
    public void queries() {
        this.iVehiculoRepository.findAllVehicles();
        this.iVehiculoRepository.findByAnioFabricacion();
        this.iVehiculoRepository.findByWheelsQuantityAndCurrentYear(10);
        this.iVehiculoRepository.findByPerdidaEconomica(1000);
    }
}
